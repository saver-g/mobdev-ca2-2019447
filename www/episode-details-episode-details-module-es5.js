      ...
      _createClass(EpisodeDetailsPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.api.getEpisode(this.episodeId).subscribe(function (res) {
            _this.episode = res[0];
            console.log(JSON.stringify(_this.episode.episode_id)); // Lists all characters, each in a separate line

            _this.characters = res[0].characters;
            console.log("character:", _this.characters);
