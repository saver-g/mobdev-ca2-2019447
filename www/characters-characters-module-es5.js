...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["characters-characters-module"], {
  ...
  function srcAppPagesCharactersCharactersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/api.service.ts"); //Source: https://ionicframework.com/docs/api/infinite-scroll


    var CharactersPage = /*#__PURE__*/function () {
      function CharactersPage(router, http, api) {
        _classCallCheck(this, CharactersPage);

        this.router = router;
        this.http = http;
        this.api = api; // Variables declared
      ...
      _createClass(CharactersPage, [{
        ...
        value: function loadData(event) {
          ...
          setTimeout(function () {
            event.target.complete(_this2.loadCharacters(event)); // The 'event' will cease once characters' length is over 60

            if (_this2.characters.length > 60) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"], _services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"]])], CharactersPage);
    /***/
  }
}]);
