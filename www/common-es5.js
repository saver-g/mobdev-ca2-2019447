...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  "./src/app/pipes/deathfilter.pipe.ts":
  /*!*******************************************!*\
    !*** ./src/app/pipes/deathfilter.pipe.ts ***!
    \*******************************************/

  /*! exports provided: DeathfilterPipe */

  /***/
  function srcAppPipesDeathfilterPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DeathfilterPipe", function () {
      return DeathfilterPipe;
    });
    /* harmony import */
    ...
    /*! @angular/core */
    "./node_modules/@angular/core/fesm2015/core.js"); // Source: https://codeburst.io/create-a-search-pipe-to-dynamically-filter-results-with-angular-4-21fd3a5bec5c


    var DeathfilterPipe = /*#__PURE__*/function () {
      function DeathfilterPipe() {
        _classCallCheck(this, DeathfilterPipe);
      }

      _createClass(DeathfilterPipe, [{
        key: "transform",
        value: function transform(deaths, keyword) {
          ...
          keyword = keyword.toLocaleLowerCase(); // Function to return results based on entered keyword

          return deaths.filter(function (death) {
            // Functions to check if entered keyword is a death name, responsible, cause or last words
            return death.death.toLocaleLowerCase().includes(keyword) || death.responsible.toLocaleLowerCase().includes(keyword) || death.cause.toLocaleLowerCase().includes(keyword) || death.last_words.toLocaleLowerCase().includes(keyword);
          });
        }
      }]);
    ...
    DeathfilterPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'deathfilter'
    })], DeathfilterPipe);
    /***/
  },
  ...
  function srcAppPipesPipesModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _quotefilter_pipe__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./quotefilter.pipe */
    "./src/app/pipes/quotefilter.pipe.ts");
    /* harmony import */


    var _deathfilter_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./deathfilter.pipe */
    "./src/app/pipes/deathfilter.pipe.ts"); // Source: https://codeburst.io/create-a-search-pipe-to-dynamically-filter-results-with-angular-4-21fd3a5bec5c
    ...
    PipesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_quotefilter_pipe__WEBPACK_IMPORTED_MODULE_2__["QuotefilterPipe"], _deathfilter_pipe__WEBPACK_IMPORTED_MODULE_3__["DeathfilterPipe"]],
      exports: [_quotefilter_pipe__WEBPACK_IMPORTED_MODULE_2__["QuotefilterPipe"], _deathfilter_pipe__WEBPACK_IMPORTED_MODULE_3__["DeathfilterPipe"]]
    })], PipesModule);
    /***/
  },
  ...
  /*! exports provided: QuotefilterPipe */

  /***/
  function srcAppPipesQuotefilterPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuotefilterPipe", function () {
      return QuotefilterPipe;
    });
    /* harmony import */
    ...
    var QuotefilterPipe = /*#__PURE__*/function () {
      function QuotefilterPipe() {
        _classCallCheck(this, QuotefilterPipe);
      }

      _createClass(QuotefilterPipe, [{
        key: "transform",
        value: function transform(quotes, keyword) {
    ...
    QuotefilterPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
      name: 'quotefilter'
    })], QuotefilterPipe);
    /***/
  },
  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! @angular/common/http */
    "./node_modules/@angular/common/fesm2015/http.js"); // Source: Mikhail Timofeev --> Mobile Development Slides & Classes
    ...
    var ApiService = /*#__PURE__*/function () {
      function ApiService(http) {
        ...
        this.http = http; // Base URL to be used by all functions
  ...
  function srcAppServicesFavouriteServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var STORAGE_KEY_3 = 'favouriteQuotes';
      ...
      _createClass(FavouriteService, [{
        ...
        value: function favouriteQuote(quoteId) {
          ...
          return this.getAllFavouriteQuotes().then(function (result) {
            if (result) {
              result.push(quoteId);
              return _this5.storage.set(STORAGE_KEY_3, result);
            } else {
              return _this5.storage.set(STORAGE_KEY_3, [quoteId]);
            }
          });
        ...
        value: function unfavouriteQuote(quoteId) {
          ...
          return this.getAllFavouriteQuotes().then(function (result) {
            if (result) {
              ...
              result.splice(index, 1);
              return _this6.storage.set(STORAGE_KEY_3, result);
            }
          });
        }
      }]);
